...
The function takes as input parameter a message string, and an optional boolean flag that determines whether the message is hex encoded or not (default: `false`).
Set the flag to `true` when you need to sign messages that are already hex encoded.
