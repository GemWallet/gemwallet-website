...
export default function PrivacyPolicy(): JSX.Element {
  return (
    <Layout
      title="Privacy Policy | GemWallet"
      description="Find out more about the Privacy Policy of GemWallet."
    >
      <main style={{ padding: "1.5rem" }}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to GemWallet.
            </p>
          </li>
          <li>
            <p>
        ...
        <p>
          Like any other website, gemwallet.app uses 'cookies'. These cookies
        ...
        <ul>
          <li>By email: contact@gemwallet.app</li>
        </ul>
      </main>
    </Layout>
  );
