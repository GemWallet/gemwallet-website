...
- Via CDN for [browser-based applications](/docs/next/api/gemwallet-api-installation#for-browser-based-applications)
- Via an NPM package for [Node.js applications](/docs/next/api/gemwallet-api-installation#for-nodejs-applications)
